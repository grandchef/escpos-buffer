...
describe('print formatted text', () => {
  it('write text', () => {
    ...
    printer.feed()
    expect(connection.buffer()).toStrictEqual(load('tm-t20_write_text', connection.buffer()))
  })
  ...
  it('write line', () => {
    ...
    expect(connection.buffer()).toStrictEqual(load('tm-t20_write_line', connection.buffer()))
  })
  ...
  it('write empty line', () => {
    ...
    const printer = new Printer(new Model('TM-T20'), connection)
    printer.writeln()
    expect(connection.buffer()).toStrictEqual(load('tm-t20_write_empty_line', connection.buffer()))
  })
  ...
  it('write bold text', () => {
    ...
    expect(connection.buffer()).toStrictEqual(load('tm-t20_bold_text', connection.buffer()))
  })
  ...
  it('write text with double width and height', () => {
    ...
    expect(connection.buffer()).toStrictEqual(load('tm-t20_large_text', connection.buffer()))
  })
  ...
  it('write italic text', () => {
    ...
    expect(connection.buffer()).toStrictEqual(load('tm-t20_italic_text', connection.buffer()))
  })
  ...
  it('write underline text', () => {
    ...
    expect(connection.buffer()).toStrictEqual(load('tm-t20_underline_text', connection.buffer()))
  })
  ...
  it('write condensed text', () => {
    ...
    expect(connection.buffer()).toStrictEqual(load('tm-t20_condensed_text', connection.buffer()))
  })
  ...
  it('emit buzzer', async () => {
    ...
    const printer = new Printer(new Model('TM-T20'), connection)
    printer.buzzer()
    expect(connection.buffer()).toStrictEqual(load('tm-t20_buzzer', connection.buffer()))
  })
  ...
  it('activate drawer', async () => {
    ...
    const printer = new Printer(new Model('TM-T20'), connection)
    printer.drawer()
    expect(connection.buffer()).toStrictEqual(load('tm-t20_drawer', connection.buffer()))
  })
  ...
  it('cut paper', async () => {
    ...
    const printer = new Printer(new Model('TM-T20'), connection)
    printer.cutter()
    expect(connection.buffer()).toStrictEqual(load('tm-t20_cut', connection.buffer()))
  })
  ...
  it('draw picture from file', async () => {
    ...
    printer.draw(image)
    printer.alignment = Align.Left
    expect(connection.buffer()).toStrictEqual(load('mp-4200_th_draw_file', connection.buffer()))
  })
  ...
  it('draw picture from buffer', async () => {
    ...
    printer.alignment = Align.Left
    printer.close()
    expect(connection.buffer()).toStrictEqual(load('mp-4200_th_draw_buffer', connection.buffer()))
  })
  ...
  it('check default columns', async () => {
    const connection = new InMemory()
    const printer = new Printer(new Model('MP-4200 TH'), connection)
    const capability = Model.ALL().find(({ model }: Capability) => model == 'MP-4200 TH')
  ...
  it('change codepage', async () => {
    ...
    expect(connection.buffer()).toStrictEqual(load('mp-4200_th_utf8_text', connection.buffer()))
  })
